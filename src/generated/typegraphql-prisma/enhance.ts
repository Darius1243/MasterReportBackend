...
const crudResolversMap = {
  ...
  DocumentType: crudResolvers.DocumentTypeCrudResolver,
...
const actionResolversMap = {
  ...
  DocumentType: {
    aggregateDocumentType: actionResolvers.AggregateDocumentTypeResolver,
    createManyDocumentType: actionResolvers.CreateManyDocumentTypeResolver,
    createManyAndReturnDocumentType: actionResolvers.CreateManyAndReturnDocumentTypeResolver,
    createOneDocumentType: actionResolvers.CreateOneDocumentTypeResolver,
    deleteManyDocumentType: actionResolvers.DeleteManyDocumentTypeResolver,
    deleteOneDocumentType: actionResolvers.DeleteOneDocumentTypeResolver,
    findFirstDocumentType: actionResolvers.FindFirstDocumentTypeResolver,
    findFirstDocumentTypeOrThrow: actionResolvers.FindFirstDocumentTypeOrThrowResolver,
    documentTypes: actionResolvers.FindManyDocumentTypeResolver,
    documentType: actionResolvers.FindUniqueDocumentTypeResolver,
    getDocumentType: actionResolvers.FindUniqueDocumentTypeOrThrowResolver,
    groupByDocumentType: actionResolvers.GroupByDocumentTypeResolver,
    updateManyDocumentType: actionResolvers.UpdateManyDocumentTypeResolver,
    updateOneDocumentType: actionResolvers.UpdateOneDocumentTypeResolver,
    upsertOneDocumentType: actionResolvers.UpsertOneDocumentTypeResolver
  },
  Inflow: {
...
const crudResolversInfo = {
  ...
  DocumentType: ["aggregateDocumentType", "createManyDocumentType", "createManyAndReturnDocumentType", "createOneDocumentType", "deleteManyDocumentType", "deleteOneDocumentType", "findFirstDocumentType", "findFirstDocumentTypeOrThrow", "documentTypes", "documentType", "getDocumentType", "groupByDocumentType", "updateManyDocumentType", "updateOneDocumentType", "upsertOneDocumentType"],
...
const argsInfo = {
  ...
  AggregateDocumentTypeArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyDocumentTypeArgs: ["data"],
  CreateManyAndReturnDocumentTypeArgs: ["data"],
  CreateOneDocumentTypeArgs: ["data"],
  DeleteManyDocumentTypeArgs: ["where"],
  DeleteOneDocumentTypeArgs: ["where"],
  FindFirstDocumentTypeArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstDocumentTypeOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyDocumentTypeArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniqueDocumentTypeArgs: ["where"],
  FindUniqueDocumentTypeOrThrowArgs: ["where"],
  GroupByDocumentTypeArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyDocumentTypeArgs: ["data", "where"],
  UpdateOneDocumentTypeArgs: ["data", "where"],
  UpsertOneDocumentTypeArgs: ["where", "create", "update"],
...
const relationResolversMap = {
  ...
  DocumentType: relationResolvers.DocumentTypeRelationsResolver,
...
const relationResolversInfo = {
  ...
  Job: ["inflows"],
  DocumentType: ["outflows"],
  Inflow: ["person", "facility", "job"],
  Outflow: ["person", "facility", "documentType"]
};
...
const modelsInfo = {
  ...
  Outflow: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
  ...
  AggregateDocumentType: ["_count", "_avg", "_sum", "_min", "_max"],
  DocumentTypeGroupBy: ["id", "name", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  OutflowGroupBy: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  DocumentTypeCount: ["outflows"],
  DocumentTypeCountAggregate: ["id", "name", "_all"],
  DocumentTypeAvgAggregate: ["id"],
  DocumentTypeSumAggregate: ["id"],
  DocumentTypeMinAggregate: ["id", "name"],
  DocumentTypeMaxAggregate: ["id", "name"],
  ...
  OutflowCountAggregate: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "_all"],
  OutflowAvgAggregate: ["id", "amount", "personId", "facilityId", "documentTypeId"],
  OutflowSumAggregate: ["id", "amount", "personId", "facilityId", "documentTypeId"],
  OutflowMinAggregate: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowMaxAggregate: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  CreateManyAndReturnPerson: ["id", "name", "email"],
  CreateManyAndReturnFacility: ["id", "name"],
  CreateManyAndReturnJob: ["id", "name"],
  CreateManyAndReturnDocumentType: ["id", "name"],
  CreateManyAndReturnInflow: ["id", "amount", "date", "description", "personId", "facilityId", "jobId", "createdAt", "updatedAt", "person", "facility", "job"],
  CreateManyAndReturnOutflow: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "person", "facility", "documentType"]
};
...
const inputsInfo = {
  ...
  DocumentTypeWhereInput: ["AND", "OR", "NOT", "id", "name", "outflows"],
  DocumentTypeOrderByWithRelationInput: ["id", "name", "outflows"],
  DocumentTypeWhereUniqueInput: ["id", "name", "AND", "OR", "NOT", "outflows"],
  DocumentTypeOrderByWithAggregationInput: ["id", "name", "_count", "_avg", "_max", "_min", "_sum"],
  DocumentTypeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name"],
  ...
  OutflowWhereInput: ["AND", "OR", "NOT", "id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "person", "facility", "documentType"],
  OutflowOrderByWithRelationInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "person", "facility", "documentType"],
  OutflowWhereUniqueInput: ["id", "AND", "OR", "NOT", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "person", "facility", "documentType"],
  OutflowOrderByWithAggregationInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  OutflowScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  DocumentTypeCreateInput: ["name", "outflows"],
  DocumentTypeUncheckedCreateInput: ["id", "name", "outflows"],
  DocumentTypeUpdateInput: ["name", "outflows"],
  DocumentTypeUncheckedUpdateInput: ["id", "name", "outflows"],
  DocumentTypeCreateManyInput: ["id", "name"],
  DocumentTypeUpdateManyMutationInput: ["name"],
  DocumentTypeUncheckedUpdateManyInput: ["id", "name"],
  ...
  OutflowCreateInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "facility", "documentType"],
  OutflowUncheckedCreateInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowUpdateInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "facility", "documentType"],
  OutflowUncheckedUpdateInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowCreateManyInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowUpdateManyMutationInput: ["amount", "date", "description", "createdAt", "updatedAt"],
  OutflowUncheckedUpdateManyInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  DocumentTypeCountOrderByAggregateInput: ["id", "name"],
  DocumentTypeAvgOrderByAggregateInput: ["id"],
  DocumentTypeMaxOrderByAggregateInput: ["id", "name"],
  DocumentTypeMinOrderByAggregateInput: ["id", "name"],
  DocumentTypeSumOrderByAggregateInput: ["id"],
  ...
  DocumentTypeNullableRelationFilter: ["is", "isNot"],
  OutflowCountOrderByAggregateInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowAvgOrderByAggregateInput: ["id", "amount", "personId", "facilityId", "documentTypeId"],
  OutflowMaxOrderByAggregateInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowMinOrderByAggregateInput: ["id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowSumOrderByAggregateInput: ["id", "amount", "personId", "facilityId", "documentTypeId"],
  ...
  OutflowCreateNestedManyWithoutDocumentTypeInput: ["create", "connectOrCreate", "createMany", "connect"],
  OutflowUncheckedCreateNestedManyWithoutDocumentTypeInput: ["create", "connectOrCreate", "createMany", "connect"],
  OutflowUpdateManyWithoutDocumentTypeNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  OutflowUncheckedUpdateManyWithoutDocumentTypeNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  DocumentTypeCreateNestedOneWithoutOutflowsInput: ["create", "connectOrCreate", "connect"],
  ...
  DocumentTypeUpdateOneWithoutOutflowsNestedInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  OutflowCreateWithoutPersonInput: ["amount", "date", "description", "createdAt", "updatedAt", "facility", "documentType"],
  OutflowUncheckedCreateWithoutPersonInput: ["id", "amount", "date", "description", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowScalarWhereInput: ["AND", "OR", "NOT", "id", "amount", "date", "description", "personId", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowCreateWithoutFacilityInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "documentType"],
  OutflowUncheckedCreateWithoutFacilityInput: ["id", "amount", "date", "description", "personId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowCreateWithoutDocumentTypeInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "facility"],
  OutflowUncheckedCreateWithoutDocumentTypeInput: ["id", "amount", "date", "description", "personId", "facilityId", "createdAt", "updatedAt"],
  OutflowCreateOrConnectWithoutDocumentTypeInput: ["where", "create"],
  OutflowCreateManyDocumentTypeInputEnvelope: ["data"],
  OutflowUpsertWithWhereUniqueWithoutDocumentTypeInput: ["where", "update", "create"],
  OutflowUpdateWithWhereUniqueWithoutDocumentTypeInput: ["where", "data"],
  OutflowUpdateManyWithWhereWithoutDocumentTypeInput: ["where", "data"],
  ...
  DocumentTypeCreateWithoutOutflowsInput: ["name"],
  DocumentTypeUncheckedCreateWithoutOutflowsInput: ["id", "name"],
  DocumentTypeCreateOrConnectWithoutOutflowsInput: ["where", "create"],
  ...
  DocumentTypeUpsertWithoutOutflowsInput: ["update", "create", "where"],
  DocumentTypeUpdateToOneWithWhereWithoutOutflowsInput: ["where", "data"],
  DocumentTypeUpdateWithoutOutflowsInput: ["name"],
  DocumentTypeUncheckedUpdateWithoutOutflowsInput: ["id", "name"],
  InflowCreateManyPersonInput: ["id", "amount", "date", "description", "facilityId", "jobId", "createdAt", "updatedAt"],
  OutflowCreateManyPersonInput: ["id", "amount", "date", "description", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowUpdateWithoutPersonInput: ["amount", "date", "description", "createdAt", "updatedAt", "facility", "documentType"],
  OutflowUncheckedUpdateWithoutPersonInput: ["id", "amount", "date", "description", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowUncheckedUpdateManyWithoutPersonInput: ["id", "amount", "date", "description", "facilityId", "documentTypeId", "createdAt", "updatedAt"],
  InflowCreateManyFacilityInput: ["id", "amount", "date", "description", "personId", "jobId", "createdAt", "updatedAt"],
  OutflowCreateManyFacilityInput: ["id", "amount", "date", "description", "personId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowUpdateWithoutFacilityInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "documentType"],
  OutflowUncheckedUpdateWithoutFacilityInput: ["id", "amount", "date", "description", "personId", "documentTypeId", "createdAt", "updatedAt"],
  OutflowUncheckedUpdateManyWithoutFacilityInput: ["id", "amount", "date", "description", "personId", "documentTypeId", "createdAt", "updatedAt"],
  ...
  OutflowCreateManyDocumentTypeInput: ["id", "amount", "date", "description", "personId", "facilityId", "createdAt", "updatedAt"],
  OutflowUpdateWithoutDocumentTypeInput: ["amount", "date", "description", "createdAt", "updatedAt", "person", "facility"],
  OutflowUncheckedUpdateWithoutDocumentTypeInput: ["id", "amount", "date", "description", "personId", "facilityId", "createdAt", "updatedAt"],
  OutflowUncheckedUpdateManyWithoutDocumentTypeInput: ["id", "amount", "date", "description", "personId", "facilityId", "createdAt", "updatedAt"]
};
